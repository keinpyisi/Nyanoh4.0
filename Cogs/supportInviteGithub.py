...
class CogSupportInviteGithub(commands.Cog):
    ...
    async def invite(self, ctx):
        ...
        embed=discord.Embed(title="Invite the Catto :", description=f"Invite {self.bot.user.mention} on your server : https://discord.com/oauth2/authorize?client_id={self.bot.user.id}&permissions=70282305&scope=bot", color=discord.Colour.random())
